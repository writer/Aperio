...
| File | Purpose |
| --- | --- |
| `internal/ingestionworker` | Detection evaluation, dedupe, auto-resolution, SIEM delivery enqueue |
...
2. `internal/ingestionworker` leases jobs, evaluates provider checks, and writes `SecurityFinding` rows.
